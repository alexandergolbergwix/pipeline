...
from ..config.namespaces import HM, NLI
...
class UriGenerator:
    ...
    def normalize_string(self, text: str) -> str:
        ...
        ascii_text = ''.join(
            ...
            if unicodedata.category(char) != 'Mn' or ord(char) < 128
        )
    ...
    def work_uri(self, title: str, author: Optional[str] = None) -> URIRef:
    ...
    def work_creation_event_uri(self, work_title: str, author: Optional[str] = None) -> URIRef:
    ...
    def evidence_chain_uri(self, manuscript_id: str, data_field: Optional[str] = None) -> URIRef:
    ...
    def text_location_uri(self, manuscript_id: str, folio: str, 
                          line: Optional[int] = None) -> URIRef:
    ...
    def paradigm_bridge_uri(self, work_title: str, tradition_name: str) -> URIRef:
        ...
        normalized_trad = self.normalize_hebrew(tradition_name) or self.normalize_string(tradition_name)

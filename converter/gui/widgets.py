    ...
    def _browse(self):
        if self.mode == "directory":
            ...
            paths, _ = QFileDialog.getOpenFileNames(
                self, "Select Files", str(Path.home()), self.file_filter
            )
            path = ";".join(paths) if paths else ""
        else:
            path, _ = QFileDialog.getOpenFileName(
                self, "Select File", str(Path.home()), self.file_filter
            )
...
class TtlPreview(QGroupBox):
    ...
    def __init__(self, title: str = "TTL Preview", parent: QWidget | None = None):
        super().__init__(title, parent)
        self._setup_ui()
...
class ValidationReport(QGroupBox):
    ...
    def __init__(self, title: str = "Validation Results", parent: QWidget | None = None):
        super().__init__(title, parent)
        self._setup_ui()

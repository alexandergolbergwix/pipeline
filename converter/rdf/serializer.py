...
class TurtleSerializer:
    ...
    def serialize(self, graph: Optional[Graph] = None, 
    ...
    def serialize_to_file(self, output_path: Path, 
...
def serialize_to_turtle(graph: Graph, output_path: Optional[Path] = None) -> str:

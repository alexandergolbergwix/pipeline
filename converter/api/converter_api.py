        ...
        for record in reader.read_file():
            try:
                ...
                if total_records > 0 and progress_callback:
                    ...
                    progress_callback(progress, f"Converted {records_processed}/{total_records} records")
                    
            except Exception as e:
                warnings.append(f"Error converting record {getattr(record, 'control_number', 'unknown')}: {e}")
...
def convert_to_json(input_path: str, output_path: Optional[str] = None,
                    include_ontology: bool = False, validate: bool = True) -> str:
    """
...
def get_annotation_types() -> Dict[str, Any]:
    ...
    return {
        "certainty": {
            ...
            "attribution_sources": ["CatalogAttribution", "ColophonAttribution", "PaleographicAttribution", "ExpertAttribution", "AIAttribution"]
        },
        "text_tradition": {
            "description": "Add text tradition and variant readings",
            "required_fields": ["manuscript_id", "tradition_name"],
            "optional_fields": ["work_title", "siglum", "variant_text", "standard_text", "folio", "line", "significance"],
            "significance_levels": ["Orthographic_variant", "Lexical_variant", "Syntactic_variant", "Semantic_variant", "Addition_variant", "Omission_variant"]
        },
        "scribal_intervention": {
            ...
            "intervention_types": ["HandChange", "TextCorrection", "MarginalAddition", "Correction_type", "Erasure_type", "Interlinear_addition_type", "Marginal_gloss_type", "Later_hand_type"]
        },
        "canonical_reference": {
        ...
        "textual_relationship": {
            ...
            "relationship_types": ["variant_of", "abridgment_of", "adaptation_of", "parallels", "possibly_realises"]
        },
        "foreign_unit": {
            ...
            "status_types": ["CoreUnit_status", "LaterAddition_status", "BinderAddition_status", "UnrelatedFragment_status", "ProtectiveLeaf_status"]
        }
    }
...
if __name__ == "__main__":
    ...
    convert_parser.add_argument("--include-ontology", action="store_true", help="Include ontology definitions")
    ...
    templates_parser.add_argument("--output-dir", "-o", default="annotation_templates", help="Output directory")

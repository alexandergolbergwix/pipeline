...
\item \textbf{Two-phase pipeline:} Phase~1 builds \code{WikidataItem} objects from authority-enriched JSON via \code{WikidataItemBuilder} (persons first, then manuscripts that reference them). Phase~2 uploads to Wikidata or exports QuickStatements.

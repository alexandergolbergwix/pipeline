...
\item \textbf{Cluster harvesting} --- fetches \code{https://viaf.org/viaf/\{id\}/viaf.json} for each matched cluster and extracts cross-referenced authority identifiers:

...
\end{tikzpicture}
\caption{Three-model NER architecture. Person NER uses keyword-based role classification; provenance v2 and contents models each load independent DictaBERT instances.}

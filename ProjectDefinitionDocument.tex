...
\hline
\endfoot
F4\_Manifestation\_Singleton & Q87167 (manuscript) & P195 (collection), P921 (main subject), P186 (material), P1104 (pages), P127 (owned by), P6216 (copyright), P8189 (NLI ID, external-id), P571 (inception), P1071 (location), P11603 (transcribed by) \\
\hline
F1\_Work & Q47461344 (written work) & P50 (author), P407 (language of work), P136 (genre, 50 QID mappings) \\
\hline
E21\_Person & Q5 (human) & P569/P570 (birth/death), P106 (occupation), P214 (VIAF, external-id) \\
\hline

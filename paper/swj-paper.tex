...
\midrule
Full pipeline (v2.0)      & 24.8 & 7.5 \\
$-$ Data loss fixes       & 22.9 & 7.5 \\
$-$ VIAF cluster harvest  & 24.8 & 5.5 \\
$-$ P17/P131 hardcoded    & 22.8 & 7.5 \\
$-$ Provenance NER        & 23.4 & 7.5 \\
$-$ Person NER            & 17.9 & 7.5 \\
$-$ Hebrew date parsing   & 23.4 & 7.5 \\
$-$ Genre QID mapping     & 24.1 & 7.5 \\
Rule-only (no NER/LOD)    & 8.0  & 2.0 \\
\bottomrule
\end{tabular}
\end{table}

Person NER has the largest individual impact ($-$6.9 stmts/MS), followed by the data loss fixes ($-$1.9) and provenance NER ($-$1.4). VIAF cluster harvesting has minimal impact on manuscript statement counts but increases person entity richness by 36\% (5.5$\to$7.5 stmts/person).
...
We presented the MHM Pipeline, a multi-strategy system for automated MARC-to-Wikidata conversion that achieves 24.8~statements per manuscript and 7.5~statements per person entity on Hebrew manuscript records from the National Library of Israel, mapping to 37~Wikidata properties. Our five-strategy approach---distant supervision NER, rule-based extraction, multi-authority linking, VIAF cluster harvesting, and property-level validation---demonstrates that no single technique suffices for high-coverage bibliographic LOD conversion.

...
\hline
\code{NerPanel} & Input JSON selector, output dir selector, model ID text field (\code{alexgoldberg/hebrew-manuscript-joint-ner-v2}), batch size spin box & \code{progress} $\to$ per-record bar; \code{log\_line} $\to$ log \\
\hline

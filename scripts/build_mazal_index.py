...
from converter.authority.mazal_index import build_index
...
def main() -> None:
    ...
    parser.add_argument(
        "--test", "-t", action="store_true", help="Run test lookups after building index"
    )
    ...
    try:
        index = build_index(str(input_path), str(output_path), verbose=not args.quiet)
